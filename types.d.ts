export type BooleanConfigProperties = 'delete.button' | 'dropdown' | 'navbar.burger' | 'navbar.dropdown' | 'tabs' | 'window.collapse';
export type StringConfigProperties = 'bulmaJS.elementIdPrefix' | 'bulmaJS.initAttribute';
export type BulmaContextualColors = 'danger' | 'dark' | 'info' | 'link' | 'primary' | 'success' | 'warning';
